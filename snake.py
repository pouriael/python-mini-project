...
def game_over():
    canvas.delete(ALL)
    canvas.create_text(canvas.winfo_width() / 2 , canvas.winfo_height()/2 , font =('Terminal',30),text= 'GAME OVER!!',fill='#DF1A2F', tag='gameover')
...
label.pack()
canvas = Canvas(window,bg = BACKGROUND_COLOR,height=GAME_HIGHT,width=GAME_WITH)
canvas.pack()
